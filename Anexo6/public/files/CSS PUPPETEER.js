...
<div class="espaciotabladearriba"> 
    <table class="tablacompleta" style="width: 100%; ">
        ...
        <tr style="width: 100%; ">
            <td style="width: 20%;" class="seccion1columnallenar" >Nombre de la instalación</td>
            <td style="width: 30%;" class="seccion1columnallenar" ></td>
            <td style="width: 20%;" class="seccion1columnallenar" >Ubicación de la instalación</td>
            <td style="width: 30%;" class="seccion1columnallenar" ></td>
        </tr>

        <tr style="width: 100%; ">
            <td style="width: 20%;" class="seccion1columnallenar" >CURR</td>
            <td style="width: 30%;" class="seccion1columnallenar"></td>
            <td style="width: 20%;" class="seccion1columnallenar">Año del reporte</td>
            <td style="width: 30%;" class="seccion1columnallenar"></td>
        </tr>
...
<div class="espaciotabladearriba"> 
    <table class="tablacompleta" style="width: 100%; ">
        <tr>
            <td colspan="10" style="font-size: 12px; text-align: center; line-height: 3px; background-color: #D9D9D9; border-color: #A6A6A6;">Sección II. Mejora continua</td>
        </tr>
        <tr style="width: 100%; ">
            <td style="width: 13%;" class="seccion2columnallenado" >Cuantificación de emisiones de metano del Año base</td>
            <td style="width: 13%;" class="seccion2columnallenado"></td>
            <td style="width: 13%;" class="seccion2columnallenado">Variación de las emisiones de metano con respectoal Año base (g/kg)</td>
            <td style="width: 13%;" class="seccion2columnallenado"></td>
            <td style="width: 13%;" class="seccion2columnallenado">En su caso, justificación técnica del incremento de las emisiones de metano</td>
            <td style="width: 35%;" class="seccion2columnallenado"></td>
        </tr>
...
<div class="espaciotabladearriba"> 
    <table class="tablacompleta" style="width: 100%; ">
        <tr>
            <td colspan="12" style="font-size: 12px; text-align: center; line-height: 3px; background-color: #D9D9D9; border-color: #A6A6A6;">Sección III. Detalle de informe trimestral</td>
        </tr>
        <tr style="width: 100%; ">
            <td style="width: 8%;" class="seccion3columnallenado" >Id del equipo o Componente</td>
            <td style="width: 8%;" class="seccion3columnallenado">Tipo de equipo o Componente</td>
            <td style="width: 7%; "class="seccion3columnallenado" >Emisiones de metano del Año base (g/k g/t)</td>
            <td style="width: 8%; "class="seccion3columnallenado" >Variación de las emisiones de metano con respecto al Año base (g/k g/t)</td>
            <td style="width: 8%; "class="seccion3columnallenado" >Acciones programadas para el año calendario del reporte</td>
            <td style="width: 8%; "class="seccion3columnallenado" >Reducción de emisiones de metano estimadas por la acción(g/k g/t)</td>
            <td style="width: 11%;" class="seccion3columnallenado" >¿Se realizó la accion programada?</td>
            <td style="width: 8%; " class="seccion3columnallenado" >Reducción de emisiones de metano por la accion(g/k g/t)</td>
            <td style="width: 8%; " class="seccion3columnallenado" >En su caso, justificación tecnica de no realización de la acción</td>
            <td style="width: 8%; " class="seccion3columnallenado" >En su caso, fecha en la que se implementará la acción programada no realizada</td>
            <td style="width: 9%; " class="seccion3columnallenado" >Acciones programadas para el siguiente año de reporte</td>
            <td style="width: 9%; " class="seccion3columnallenado" >Fecha en la que se implementarán las acciones programadas para el siguiente año de reporte</td>
        </tr >

        <tr style="width: 100%; ">
            <td style="width: 8%;  " class="seccion3columnallenado" ></td>
            <td style="width: 8%;  " class="seccion3columnallenado"></td>
            <td style="width: 7%;  " class="seccion3columnallenado"></td>
            <td style="width: 8%;  " class="seccion3columnallenado"></td>
            <td style="width: 8%;  " class="seccion3columnallenado"></td>
            <td style="width: 8%;  " class="seccion3columnallenado"></td>
            <td style="width: 11%; " class="seccion3columnallenado">
            ...
            <td style="width: 8%;"  class="seccion3columnallenado"></td>
            <td style="width: 8%;"  class="seccion3columnallenado"></td>
            <td style="width: 9%;"  class="seccion3columnallenado"></td>
            <td style="width: 9%;"  class="seccion3columnallenado"></td>
        </tr>
...
<thead >
  <tr>
    <td colspan="9" style="font-size: 12px; text-align: center; line-height: 3px; background-color: #D9D9D9; border-color: #A6A6A6; ">Sección IV. Operaciones en pozos fuera del Año base</td>
    
  </tr>
  <tr style="font-size: 10px; text-align: center; line-height: 4px;">
    <td colspan="7" style="line-height: 4px;" class="seccion4columnarelleno">Identificación</td>
    <td             style="line-height: 4px;" class="seccion4columnarelleno">Clasificación</td>
    <td             style="line-height: 4px;" class="seccion4columnarelleno">Cuantificación</td>
  </tr>
</thead>
<tbody id="tabla-body" style="width: 100%; background-color: #ffffff; border-color: #A6A6A6;">

  <tr style="font-size: 10px; text-align: center;">
    <td style="width: 10%; " class="seccion4columnfunciones">Id del pozo</td>
    <td style="width: 10%; " class="seccion4columnfunciones">Tipo de pozo</td>
    <td style="width: 10%; " class="seccion4columnfunciones">Operaciones</td>
    <td style="width: 10%; " class="seccion4columnfunciones">Fecha de inicio de la operación</td>
    <td style="width: 10%; " class="seccion4columnfunciones">Estado del pozo</td>
    <td style="width: 10%; " class="seccion4columnfunciones">Condiciones operativas del pozo</td>
    <td style="width: 10%; " class="seccion4columnfunciones">Elementos utilizados en la identificación</td>
    <td style="width: 10%; " class="seccion4columnfunciones">Tipo de emisión de metano</td>
    <td style="width: 10%; " class="seccion4columnfunciones">Emisiones de metano (g/kg/t)</td>
  </tr>

  
  <tr style="font-size: 10px; text-align: center; line-height: 10px;  ">    <!-- Fila2 -->
    ...
    <div style="height: 100%; flex-direction: column; justify-content: space-between; align-items: center;">
  ...
  <td style="width: 10%; " class="seccion4columnopciones">
    <div style="height: 100%; flex-direction: column; justify-content: space-between; align-items: center;">
      <div style="width: 100%; background-color:  white; height: 33.33%; border-bottom: 1px solid #A6A6A6; padding-bottom: 0px; ">
        <label style="margin-left: 2px; font-size: 10px; "><input type="radio"  name="estado">Destrucción</label>
      </div>
      <div style="width: 100%; background-color: white; height: 33.33%; border-bottom: 1px solid #A6A6A6; padding-top: 0px; padding-bottom: 4px; ">
        <label style="margin-left: 1px;"><input type="radio" name="estado">Emisiones<span style="padding-left: 13px;"> por Fuga</span></label>
      </div>
      <div style="width: 100%; background-color: white; height: 33.33%; padding-top: 0px; padding-bottom: 0px; margin-bottom: 0px; font-size: 10px; ">
  ...
  <tr style="font-size: 10px; text-align: center; line-height: 10px;  ">    <!-- Fila3 -->
    <td style="width: 10%; " class="seccion4columnvacias"> </td>
    <td style="width: 10%; " class="seccion4columnvacias"> </td>
    <td style="width: 10%; " class="seccion4columnvacias"> </td>
    <td style="width: 10%; " class="seccion4columnvacias"> </td>
  ...
  <tr style="font-size: 10px; text-align: center; line-height: 10px;  ">    <!-- Fila4 -->
    <td style="width: 10%; " class="seccion4columnvacias"> </td>
    <td style="width: 10%; " class="seccion4columnvacias"> </td>
    <td style="width: 10%; " class="seccion4columnvacias"> </td>
    <td style="width: 10%; " class="seccion4columnvacias"> </td>
...
<thead >
<tr>
  <td colspan="10" style="font-size: 12px; text-align: center; line-height: 3px; background-color: #D9D9D9; border-color: #A6A6A6; ">Sección V. Diagnóstico de los equipos y/o Componentes fuera del PPCIEM</td>
  
</tr>
<tr style="font-size: 10px; text-align: center; line-height: 4px;">
  <td colspan="8" class="seccion4columnarelleno">Identificación</td>
  <td             class="seccion4columnarelleno">Clasificación</td>
  <td             class="seccion4columnarelleno">Cuantificación</td>
</tr>
</thead>
<tbody id="tabla-body" style="width: 100%; background-color: #ffffff; border-color: #A6A6A6; padding: ">
<tr style="font-size: 10px; text-align: center; line-height: 10px;  ">
  <td style="width: 10%; " class="seccion4columnarelleno">Id del pozo, equipo o Componente</td>
  <td style="width: 10%; " class="seccion4columnarelleno">Tipo del pozo, equipo o Componente</td>
  <td style="width: 10%; " class="seccion4columnarelleno">Operaciones del pozo</td>
  <td style="width: 10%; " class="seccion4columnarelleno">Operaciones asociadas al equipo o Componente</td>
  <td style="width: 10%; " class="seccion4columnarelleno">Fecha de identificación (dd/mm/aaaa)</td>
  <td style="width: 10%; " class="seccion4columnarelleno">Estado del pozo, equipo o Componente</td>
  <td style="width: 10%; " class="seccion4columnarelleno">Condiciones operativas del pozo, equipo o COmponente</td>
  <td style="width: 10%; " class="seccion4columnarelleno">Elementos utilizados en la identificación</td>
  <td style="width: 10%; " class="seccion4columnarelleno">Tipo de emisión de metano</td>
  <td style="width: 10%; " class="seccion4columnarelleno">Emisiones de metano (g/kg/t)</td>
</tr>
...
<div class="espaciotabladearriba"> 
    <table class="tablacompleta" style="width: 100%; ">
        ...
        <tr style="width: 100%; ">
            <td style="width: 8%;  " class="seccion6columnas" >Id del equipo o Componente</td>
            <td style="width: 8%;  " class="seccion6columnas">Tipo de equipo o Componente</td>
            <td style="width: 8%;  " class="seccion6columnas" >Emiiones de metano del Año base (g/k g/t)</td>
            <td style="width: 7%;  " class="seccion6columnas" >Variación de las emisiones de metano con respecto al Año base (g/k g/t)</td>
            <td style="width: 8%;  " class="seccion6columnas" >Acciones programadas para el año calendario del reporte</td>
            <td style="width: 8%;  " class="seccion6columnas" >Reducción de emisiones de metano estimadas por la acción(g/k g/t)</td>
            <td style="width: 11%; " class="seccion6columnas" >¿Se realizó la accion programada?</td>
            <td style="width: 8%;  " class="seccion6columnas" >Reducción de emisiones de metano por la accion(g/k g/t)</td>
            <td style="width: 9%;  " class="seccion6columnas" >En su caso, justificación tecnica de no realización de la acción</td>
            <td style="width: 9%;  " class="seccion6columnas" >En su caso, fecha en la que se implementará la acción programada no realizada</td>
            <td style="width: 8%;  " class="seccion6columnas" >Acciones programadas para el siguiente año de reporte</td>
            <td style="width: 8%;  " class="seccion6columnas" >Fecha en la que se implementarán las acciones programadas para el siguiente año de reporte</td>
        </tr>

        <tr style="width: 100%; ">
            <td style="width: 8%;  " class="seccion6columnas" ></td>
            <td style="width: 8%;  " class="seccion6columnas" ></td>
            <td style="width: 8%;  " class="seccion6columnas" ></td>
            <td style="width: 7%;  " class="seccion6columnas" ></td>
            <td style="width: 8%;  " class="seccion6columnas" ></td>
            <td style="width: 8%;  " class="seccion6columnas" ></td>
            <td style="width: 11%; " class="seccion6columnas" >
            <div style="display: -webkit-box; display: -ms-flexbox; display: flex; width: 100%">
              <div style="width: 50%; border-right: 1px solid #A6A6A6; padding-top: 6px; padding-bottom: 6px; ">
                <label class=""><input type="radio" style=" margin-right: 3px; " name="estado">Si</label>
              </div>
              <div style="width: 50%; padding-top: 6px;">
                <label class=""><input type="radio" style=" margin-right: 3px;" name="estado">No</label>
              </div>
            </div>
            </td>
            <td style="width: 8%;  " class="seccion6columnas" ></td>
            <td style="width: 9%;  " class="seccion6columnas" ></td>
            <td style="width: 9%;  " class="seccion6columnas" ></td>
            <td style="width: 8%;  " class="seccion6columnas" ></td>
            <td style="width: 8%;  " class="seccion6columnas" ></td>
        </tr>
